...
export default function Page() {
  return (
    <main className="relative flex min-h-screen flex-col items-center overflow-y-hidden bg-[#440c0c] px-7 sm:px-12 lg:px-16">
      ...
      <div className="relative z-10 mt-6 flex flex-col items-center lg:mt-14">
        ...
        <div className="absolute left-1/2 top-[15%] -translate-x-1/2 lg:top-[22%]">
        ...
        <p
          className="-mt-6 max-w-[263px] text-center font-westmeath text-[15px] text-[#F4D38E] sm:max-w-none lg:-mt-8 lg:text-4xl"
